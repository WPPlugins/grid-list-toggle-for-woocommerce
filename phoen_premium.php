				...
				<div class="premium-box-container">
						...
						<div class="description">
							...
							<div class="pho-plugin-content">
								<p>
										  With this option you could customize the tab alignment , active color , BG color , hover bg color , padding , active border color.
										</p>
						...
						<div class="description">
							<div class="pho-desc-head"><h2>Tab styling settings</h2></div>
							<div class="pho-plugin-content">
								<p>
										  With this feature you could set the tab icon , size , color. Can enable / disable tab icon. 
										</p>
								<div class="pho-img-bg">
						...
						<div class="description">
							<div class="pho-desc-head"><h2>Masonry style 1</h2></div>
							<div class="pho-plugin-content">
								<p>
										  Frontend view of the masonry style 1.
										</p>
								<div class="pho-img-bg">
						...
						<div class="description">
							<div class="pho-desc-head"><h2>Masonry style 2</h2></div>
							<div class="pho-plugin-content">
								<p>
										  Frontend view of the masonry style 2.
										</p>
								<div class="pho-img-bg">
						...
						<div class="description">
							<div class="pho-desc-head"><h2>Masonry style 3</h2></div>
							<div class="pho-plugin-content">
								<p>
										  Frontend view of the masonry style 3.
										</p>
								<div class="pho-img-bg">
